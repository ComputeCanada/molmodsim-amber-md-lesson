...
![Figure: Initial Bilayer]({{ page.root }}/fig/bilayer_small.png){:width="30%"}

{% if site.show_comments %}
To create a simple bilayer, you simply need to specify what lipids to use and the size of the membrane. The program will add water and neutralize the system automatically.  
Box information you can find in the packmol-memgen.log.
{% endif %}
...
![Figure: Initial bilayer]({{ page.root }}/fig/protein-bilayer.png){:width="50%"}
